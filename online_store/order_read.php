...
<td class = 'col-10' style = 'border:none;'> <div class = 'input-group rounded'>

<input type = 'text'  class = 'form-control rounded' placeholder = 'Search by order ID OR customer names...' aria-label = 'Search'
...
<td style = 'border:none;'><a href = 'orders.php' class = 'btn btn-primary'>Create New Order</a></td>
</tr>
</table>
<?php
