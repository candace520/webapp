            ...
            <?php
                if ($_POST) {
                    ...
                    try {
                        ...
                        // insert query
                        $query = "INSERT INTO products SET fileToUpload=:fileToUpload,name=:name,nameMalay=:nameMalay,description=:description, price=:price, promotion_price=:promotion_price,manufacture_date=:manufacture_date,expired_date=:expired_date,
                        created=:created";
